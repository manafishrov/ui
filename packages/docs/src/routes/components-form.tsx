...
const DEMO_DEFAULT_VALUES: FormValues = {
  text: '',
  email: '',
  textarea: '',
  number: 0,
...
const TextFieldSection = withForm({
...
const EmailFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='email'
...
const TextareaFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='textarea'
...
const NumberFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='number'
...
const CheckboxFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='checkbox'
...
const RadioFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='radio'
...
const SliderFieldSection = withForm({
  defaultValues: DEMO_DEFAULT_VALUES,
  render: (props) => (
    <props.form.AppField
      name='slider'
