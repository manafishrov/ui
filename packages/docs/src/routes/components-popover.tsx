        ...
        <PopoverContent>
          ...
          <div class='gap-4 py-4 grid'>
            <div class='gap-4 grid grid-cols-3 items-center'>
              ...
              <input
                class='h-9 px-3 py-1 text-sm shadow-sm col-span-2 flex w-full rounded-md border border-input bg-transparent transition-colors outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50'
                value='100%'
              />
            </div>
          </div>
