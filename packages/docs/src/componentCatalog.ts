...
export const components: DocComponent[] = [
  ...
  { name: 'Avatar', to: '/components-avatar', descriptionKey: 'docs_component_avatar_description' },
  { name: 'Badge', to: '/components-badge', descriptionKey: 'docs_component_badge_description' },
  {
    name: 'Breadcrumb',
    to: '/components-breadcrumb',
    descriptionKey: 'docs_component_breadcrumb_description',
  },
  { name: 'Button', to: '/components-button', descriptionKey: 'docs_component_button_description' },
  { name: 'Card', to: '/components-card', descriptionKey: 'docs_component_card_description' },
  {
    name: 'Carousel',
  ...
  { name: 'Dialog', to: '/components-dialog', descriptionKey: 'docs_component_dialog_description' },
  { name: 'Empty', to: '/components-empty', descriptionKey: 'docs_component_empty_description' },
  { name: 'Field', to: '/components-field', descriptionKey: 'docs_component_field_description' },
  { name: 'Form', to: '/components-form', descriptionKey: 'docs_component_form_description' },
  {
    name: 'Hover Card',
  ...
  },
  {
    ...
    descriptionKey: 'docs_component_input_group_description',
  },
  { name: 'Item', to: '/components-item', descriptionKey: 'docs_component_item_description' },
  { name: 'Kbd', to: '/components-kbd', descriptionKey: 'docs_component_kbd_description' },
  { name: 'Link', to: '/components-link', descriptionKey: 'docs_component_link_description' },
  {
    name: 'Marquee',
    to: '/components-marquee',
    descriptionKey: 'docs_component_marquee_description',
  },
  { name: 'Menu', to: '/components-menu', descriptionKey: 'docs_component_menu_description' },
  {
    name: 'Menu Combobox',
  ...
  { name: 'Select', to: '/components-select', descriptionKey: 'docs_component_select_description' },
  {
    name: 'Separator',
    to: '/components-separator',
    descriptionKey: 'docs_component_separator_description',
  },
  { name: 'Sheet', to: '/components-sheet', descriptionKey: 'docs_component_sheet_description' },
  {
    name: 'Sidebar',
  ...
  { name: 'Slider', to: '/components-slider', descriptionKey: 'docs_component_slider_description' },
  {
    name: 'Spinner',
  ...
  { name: 'Switch', to: '/components-switch', descriptionKey: 'docs_component_switch_description' },
  { name: 'Table', to: '/components-table', descriptionKey: 'docs_component_table_description' },
  { name: 'Tabs', to: '/components-tabs', descriptionKey: 'docs_component_tabs_description' },
  {
    name: 'Tags Input',
  ...
  { name: 'Toggle', to: '/components-toggle', descriptionKey: 'docs_component_toggle_description' },
  {
    name: 'Tooltip',
